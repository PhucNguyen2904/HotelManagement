...
?>
<div class="fleurdesel-animate text-black fleurdesel-animate--icon text-center <?php echo esc_attr( $el_class ); ?>" <?php print $color; // WPCS: xss ok.?>>
	...
	<?php endif; ?>
	<div class="fleurdesel-animate__number font-1 font-700 h1 mb-15" data-counterup-time="1500" data-counterup-delay="30" data-counterup-beginat="0" <?php print $color; // WPCS: xss ok.?>>
