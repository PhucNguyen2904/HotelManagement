...
<div class="fleurdesel-catalog <?php echo esc_attr( $el_class ); ?>">
	<div class="fleurdesel-catalog__wrap border-bottom">
		...
		<div class="fleurdesel-catalog__right">
			<div class="fleurdesel-catalog__price font-500 fz-20 text-color-1"><?php echo esc_attr( $catalogue_menu['price'] ); ?></div>
			<?php if ( $catalogue_menu['price_unit'] ) : ?>
			<div class="text-uppercase letter-spacing-2 font-700 fz-12 text-black"><?php esc_html_e( '/', 'fleurdesel' ) ?><?php echo esc_attr( $catalogue_menu['price_unit'] ); ?></div>
			<?php endif; ?>
		</div>
		<?php endif; ?>
