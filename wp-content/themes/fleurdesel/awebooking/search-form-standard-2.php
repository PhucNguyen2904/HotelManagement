			...
			<div class="awebooking-wrapper inline">
				<div class="apb-content text-center clearfix">
					...
					<div class="apb-field apb-field--departure searchbox__box--checkout">
						...
						<div class="apb-field-group">
							<i class="awebookingf awebookingf-calendar"></i>
							<input type="text" data-bind="value: checkOutFormatted('<?php echo esc_attr( $date_format ); ?>')" class="searchbox__input-display awebooking-datepicker awebooking-datepicker awebooking-input awebooking-end-date apb-input apb-calendar" placeholder="<?php esc_html_e( 'Departure Date', 'fleurdesel' ); ?>">
