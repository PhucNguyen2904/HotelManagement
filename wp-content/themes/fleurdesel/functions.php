...
if ( ! function_exists( 'fleurdesel_setup' ) ) :
	...
	function fleurdesel_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'fleurdesel_custom_background_args', array(
...
function fleurdesel_scripts() {
	...
	// Google fonts.
	wp_enqueue_style( 'fleurdesel-google-font', fleurdesel_fonts_url(), array(), null );
	wp_enqueue_style( 'font-awesome', get_stylesheet_directory_uri() . '/src/css/font-awesome' . $suffix . '.css', array(), '4.7.0' );
	wp_enqueue_style( 'fleurdesel-icons', get_template_directory_uri() . '/dist/css/font-fleurdeselhotel' . $suffix . '.css', array(), '28112016' );
	wp_enqueue_style( 'slick', get_stylesheet_directory_uri() . '/src/css/slick.css', array(), '1.6.0' );
	wp_enqueue_style( 'magnific-popup', get_stylesheet_directory_uri() . '/src/css/magnific-popup.css', array(), '1.1.0' );

	if ( ! is_404() ) {
		$style_css = is_rtl() ? '/dist/css/main-rtl' . $suffix . '.css' : '/dist/css/main'. $suffix .'.css';
		wp_enqueue_style( 'fleurdesel-style', get_template_directory_uri() . $style_css, array(), $version );
	} else {
		wp_enqueue_style( 'fleurdesel-404', get_template_directory_uri() . '/dist/css/404' . $suffix . '.css', array(), $version );
	}

	wp_enqueue_script( 'tether', get_template_directory_uri() . '/src/js/tether.min.js', array( 'jquery' ), '032017', true );

	wp_enqueue_script( 'jquery-ui-datepicker' );
	wp_enqueue_script( 'fleurdesel-navigation', get_template_directory_uri() . '/src/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'fleurdesel-skip-link-focus-fix', get_template_directory_uri() . '/src/js/skip-link-focus-fix.js', array(), '20151215', true );
	wp_enqueue_script( 'slick', get_template_directory_uri() . '/src/js/slick' . $suffix . '.js', array( 'jquery' ), '1.8.0', true );
	wp_enqueue_script( 'magnific-popup', get_template_directory_uri() . '/src/js/jquery.magnific-popup' . $suffix . '.js', array( 'jquery' ), '1.1.0', true );
	wp_enqueue_script( 'jquery-waypoints', get_template_directory_uri() . '/src/js/jquery.waypoints.min.js', array( 'jquery' ), '4.0.1', true );
	wp_enqueue_script( 'counterup', get_template_directory_uri() . '/src/js/jquery.counterup.min.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'imagesloaded' );
	wp_enqueue_script( 'masonry', get_template_directory_uri() . '/src/js/masonry.pkgd.min.js', array( 'jquery' ), '4.0.0', true );
	wp_enqueue_script( 'isotope', get_template_directory_uri() . '/src/js/isotope.pkgd.min.js', array( 'jquery' ), '3.0.1', true );
	wp_enqueue_script( 'packery', get_template_directory_uri() . '/src/js/packery.pkgd.min.js', array( 'jquery' ), '2.0.0', true );
	wp_enqueue_script( 'jff-vendor', get_template_directory_uri() . '/src/js/jff-vendor.min.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'jff-utils', get_template_directory_uri() . '/src/js/jff-utils.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'fleur-select2', get_template_directory_uri() . '/src/js/select2.full.min.js', array( 'jquery' ), '4.0.3', true );

	wp_register_script( 'fleurdesel-awebooking-form', get_template_directory_uri() . '/src/js/awebooking-custom-datepicker.js', array( 'jquery' ), $version, true );

	wp_enqueue_script( 'fleurdesel-main', get_template_directory_uri() . '/src/js/main.js', array( 'jquery' ), $version, true );
...
function fleurdesel_defaults() {
	$options = apply_filters( 'fleurdesel_defaults', array(
		// Site logo.
