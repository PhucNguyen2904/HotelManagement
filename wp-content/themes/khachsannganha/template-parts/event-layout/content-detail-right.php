	...
	<div class="row">
		...
		<div class="col-md-5">
			<div class="event-info">
				<?php if ( $location ) : ?>
				<div class="event-info__title"><?php esc_html_e( 'Information Event', 'fleurdesel' ); ?></div>
				<div class="mb-20">
				...
				<div class="mb-20">
					...
					<p><?php esc_html_e( 'Start: ', 'fleurdesel' ); ?> <?php echo esc_attr( $start_date_str ) ?></p>
					<?php if ( $end_date ) : ?>
					<p><?php esc_html_e( 'End: ', 'fleurdesel' ); ?> <?php echo esc_attr( $end_date ) ?></p>
					<?php endif; ?>
				</div>
				<?php if ( $map ) : ?>
				<div class="mb-20">
				...
				<div>
					<p class="event-title font-500 fz-20 mr-5 inline-block">
						<span><?php esc_html_e( 'Price:', 'fleurdesel' ) ?></span>
					</p>
					<p class="text-color-1 fz-20 inline-block">
						<span class="event-price__value"><?php echo esc_attr( $price['value'] ) ?></span>
						<?php esc_html_e( '/', 'fleurdesel' ) ?>
						<span class="event-price__unit"><?php echo esc_attr( $price['unit'] ) ?></span>
					</p>
				</div>
				<?php endif; ?>
			</div>
			...
			<div class="event-info">
				<?php if ( $phone ) : ?>
				<div class="event-info__title"><?php esc_html_e( 'Organizer', 'fleurdesel' ); ?></div>
				...
				<div class="event-info__item mb-20">
					...
					<p>
						<a href="mailto:<?php echo esc_html( $email ) ?>" target="blank"><?php echo esc_html( $email ) ?></a>
					</p>
				</div>
				<?php endif; ?>
			...
			<div class="post-data pt-0">
				<div class="event-time">
					...
					<div class="event-time__month">
						<span><?php echo esc_attr( $start_month ); ?></span>
						<span><?php echo esc_attr( $start_year ); ?></span>
					</div>
				</div>
