...
const IconPhone = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1B3A4B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div className="rounded-xl border border-[#EAE6DF] bg-white p-6 text-center transition-all duration-200 hover:border-[var(--color-secondary)] hover:shadow-[0_4px_20px_rgba(27,58,75,0.1)]">
              ...
              <h3 className="mb-2 text-xl font-semibold text-[#1B3A4B]">Vị trí tuyệt đẹp</h3>
            ...
            <div className="rounded-xl border border-[#EAE6DF] bg-white p-6 text-center transition-all duration-200 hover:border-[var(--color-secondary)] hover:shadow-[0_4px_20px_rgba(27,58,75,0.1)]">
              ...
              <h3 className="mb-2 text-xl font-semibold text-[#1B3A4B]">View biển tuyệt đẹp</h3>
              <p className="text-sm text-[#6B7280]">
            ...
            <div className="rounded-xl border border-[#EAE6DF] bg-white p-6 text-center transition-all duration-200 hover:border-[var(--color-secondary)] hover:shadow-[0_4px_20px_rgba(27,58,75,0.1)]">
              ...
              <h3 className="mb-2 text-xl font-semibold text-[#1B3A4B]">Phòng sạch đẹp</h3>
              <p className="text-sm text-[#6B7280]">
            ...
            <div className="rounded-xl border border-[#EAE6DF] bg-white p-6 text-center transition-all duration-200 hover:border-[var(--color-secondary)] hover:shadow-[0_4px_20px_rgba(27,58,75,0.1)]">
              ...
              <h3 className="mb-2 text-xl font-semibold text-[#1B3A4B]">Giá tốt nhất</h3>
              <p className="text-sm text-[#6B7280]">
      ...
      <section className="bg-[var(--color-accent)] py-24">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              <h2 className="mb-6 text-3xl font-semibold text-[var(--color-primary)]">Vị Trí & Liên Hệ</h2>
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-text)]/80">
                      <a href="tel:0912326997" className="text-[var(--color-secondary)] hover:underline">
                        0912 326 997
                      </a>
                    </p>
                  </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
            ...
            <div>
              ...
              <p className="mb-6 text-lg text-[var(--color-primary)]/80">
                Đội ngũ chuyên gia của chúng tôi sẵn sàng giúp bạn lên kế hoạch cho kỳ nghỉ hoàn hảo tại Ngân Hà Hotel. 
                Chúng tôi sẽ tư vấn chi tiết về các phòng, dịch vụ và hoạt động phù hợp nhất với nhu cầu của bạn.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[var(--color-primary)]">Tư vấn phòng phù hợp với ngân sách</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-secondary)]">
                    <span className="text-white font-semibold">✓</span>
                  </div>
                  <span className="text-[var(--color-primary)]">Gợi ý các hoạt động và dịch vụ đặc biệt</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-secondary)]">
                    <span className="text-white font-semibold">✓</span>
                  </div>
                  <span className="text-[var(--color-primary)]">Hỗ trợ sắp xếp từ lúc booking đến check-in</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <a
                href="tel:0912326997"
                className="flex items-center gap-4 rounded-xl bg-[var(--color-secondary)]/15 p-5 transition-all hover:bg-[var(--color-secondary)]/25 border border-[var(--color-secondary)]/30"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[var(--color-secondary)]">
                  <IconPhone />
                </div>
                <div className="text-left">
                  <p className="text-sm font-semibold text-[var(--color-secondary)]">Gọi ngay</p>
                  <p className="text-lg font-bold text-[var(--color-primary)]">0912 326 997</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-sm font-semibold text-[var(--color-secondary)]">Gửi email</p>
                  <p className="text-lg font-bold text-[var(--color-primary)] truncate">nganhahotelquanlan@gmail.com</p>
                </div>
              </a>

              <Link
                href="/contact"
                className="flex items-center justify-center gap-3 rounded-xl bg-[var(--color-secondary)] px-8 py-4 font-semibold text-white transition-all hover:shadow-lg hover:scale-105"
              >
                <span>Liên hệ qua form</span>
                <span>→</span>
              </Link>

              <p className="text-center text-sm text-[var(--color-primary)]/60 pt-4">
