...
import { Button, Card, CardContent, ImageGallery } from '@/components/ui';
      ...
      <div className="mx-auto grid w-full max-w-screen-2xl grid-cols-12 gap-16 px-8">
        <div className="col-span-12 lg:col-span-8">
          <div className="mb-8">
            <Link
              href="/rooms"
              className="inline-flex items-center gap-2 text-sm text-manor-muted hover:text-manor-primary"
            >
          ...
          <Card className="bg-manor-surface-low p-2">
            <CardContent className="p-8">
              ...
              {room.description && (
                <p className="mb-8 max-w-3xl text-lg leading-relaxed text-manor-muted">
                  {room.description}
                </p>
              )}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-x-10 gap-y-4 md:grid-cols-2">
                    {room.amenities.map((amenity) => (
                      <div
                        key={amenity.id}
                        className="flex items-center gap-3 text-manor-primary"
                      >
