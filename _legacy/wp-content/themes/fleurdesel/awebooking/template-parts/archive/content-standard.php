...
$post_class = 'offset-lg-1 col-lg-10';

?>
<div <?php post_class( $post_class ); ?>>
	<div class="fleurdesel-room fleurdesel-room--standard">
		...
		<div class="fleurdesel-room__data text-<?php echo esc_attr( $alignment ); ?> mx-auto">
