...
$form_classes = array(
	...
	'fleurdesel-awebooking--standard-1',
...
$date_format = apply_filters( 'fleurdesel_search_form_standard_1_date_format', 'm/d/Y' );
?>
			...
			<div class="awebooking-wrapper">
				<div class="apb-content text-center clearfix">
					...
					<div class="apb-field apb-field--arrival">
						<label><?php esc_html_e( 'Arrival Date', 'fleurdesel' ); ?></label>
						<div class="apb-field-group searchbox__box--checkin">
							<i class="apbf apbf-select"></i>
							<input type="text" data-bind="value: checkInFormatted('<?php echo esc_attr( $date_format ); ?>')" class="searchbox__input-display awebooking-datepicker awebooking-input awebooking-start-date apb-input apb-calendar" placeholder="<?php esc_html_e( 'Arrival Date', 'fleurdesel' ); ?>">
							<input type="hidden" data-bind="value: checkInDate" class="searchbox__input searchbox__input--checkin input-transparent" name="check_in" value="<?php echo esc_attr( $res_request['check_in'] ); ?>" placeholder="<?php echo esc_html__( 'Arrival Date', 'fleurdesel' ); ?>" autocomplete="off" aria-haspopup="true" />
						</div>
					</div>

					<div class="apb-field apb-field--departure">
						<label><?php esc_html_e( 'Departure Date', 'fleurdesel' ); ?></label>
						<div class="apb-field-group searchbox__box--checkout">
							<i class="apbf apbf-select"></i>
							<input type="text" data-bind="value: checkOutFormatted('<?php echo esc_attr( $date_format ); ?>')" class="searchbox__input-display awebooking-datepicker awebooking-input awebooking-end-date apb-input apb-calendar" placeholder="<?php esc_html_e( 'Departure Date', 'fleurdesel' ); ?>">
							<input type="hidden" data-bind="value: checkOutDate" class="searchbox__input searchbox__input--checkout input-transparent" name="check_out" value="<?php echo esc_attr( $res_request['check_out'] ); ?>" placeholder="<?php echo esc_html__( 'Departure Date', 'fleurdesel' ); ?>" autocomplete="off" aria-haspopup="true" />
						</div>
					</div>
					...
					<?php if ( $atts['occupancy'] ) : ?>
						...
						<div class="apb-field apb-field--adult">
							<label><?php esc_html_e( 'Adults', 'awebooking' ); ?></label>
							<div class="apb-field-group">
								<i class="apbf apbf-select"></i>
						...
						<div class="apb-field apb-field--child">
							<label><?php esc_html_e( 'Infants', 'awebooking' ); ?></label>
							<div class="apb-field-group">
								<i class="apbf apbf-select"></i>
