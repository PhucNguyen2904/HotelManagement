...
<div class="fleurdesel-iconbox <?php echo esc_attr( $el_class ); ?>">
	<div class="fleurdesel-iconbox__wrap">
		<?php if ( $icon ) : ?>
			<div class="fleurdesel-iconbox__media h1 text-color-1 mb-15" <?php print $color_attr; // WPCS: xss ok. ?>>
		...
		<div class="fleurdesel-iconbox__data">
			<?php if ( $atts['title'] ) : ?>
				<h2 class="fleurdesel-iconbox__title h6 font-2 font-500 mb-20" <?php print $color_attr; // WPCS: xss ok. ?>>
			...
			<?php if ( $atts['desc'] ) : ?>
				<p class="fleurdesel-iconbox__desc" <?php print $color_attr; // WPCS: xss ok. ?>><?php echo wp_kses_post( nl2br( $atts['desc'] ) ); ?></p>
			<?php endif; ?>
		</div>
