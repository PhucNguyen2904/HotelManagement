...
<div class="fleurdesel-iconbox <?php echo esc_attr( $el_class ); ?>">
	<div class="fleurdesel-iconbox__wrap">
		<?php if ( $icon ) : ?>
			<div class="fleurdesel-iconbox__media fz-40 text-color-1" <?php print $color_attr; // WPCS: xss ok. ?>>
		...
		<?php if ( $atts['title'] ) : ?>
			<h2 class="fleurdesel-iconbox__title font-2 font-400 fz-14" <?php print $color_attr; // WPCS: xss ok. ?>>
